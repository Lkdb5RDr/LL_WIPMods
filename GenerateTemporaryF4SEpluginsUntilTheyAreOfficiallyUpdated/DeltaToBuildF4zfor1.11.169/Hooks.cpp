...
namespace hookedAddresses
{
	...
	RelocAddr<uintptr_t>	kDialogueResponse_Ctor(MAKE_RVA(0x000000140BAB9A0));
	...
	RelocAddr<uintptr_t>	kSubtitleManager_ShowSubtitle(MAKE_RVA(0x0000001410794F0));
	...
	RelocAddr<uintptr_t>	kSubtitleManager_DisplayNextSubtitle(MAKE_RVA(0x000000141079B90));
