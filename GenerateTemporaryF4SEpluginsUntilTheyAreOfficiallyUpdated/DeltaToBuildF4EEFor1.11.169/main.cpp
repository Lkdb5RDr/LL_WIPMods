...
RelocAddr <_InstallArmorAddon> InstallArmorAddon_Original(0x0035C2C0);
RelocAddr <uintptr_t> InstallArmorAddon_Start(0x00356E40 + 0xB4C);

typedef void (* _ApplyMaterialProperties)(NiAVObject * object);
RelocAddr <_ApplyMaterialProperties> ApplyMaterialProperties(0x021BC6A0); // 42D562E443C0313BACEF58FC1A4508489CED355F+33A
RelocAddr <uintptr_t> HairColorModify_Start(0x006EBD20 + 0x262);

RelocAddr <uintptr_t> GetHairTexturePath_Start(0x006E9360 + 0x10d4);

RelocPtr<UInt32> g_faceGenTextureWidth(0x02F37900); // F5F0D2A6AFBE88D06472E751C88521770B465B79+148
...
RelocAddr <_InitializeSharedTarget> InitializeSharedTarget(0x01834410);
