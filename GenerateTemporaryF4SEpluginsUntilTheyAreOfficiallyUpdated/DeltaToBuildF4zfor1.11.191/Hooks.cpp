...
namespace hookedAddresses
{
	...
	RelocAddr<uintptr_t>	kDialogueResponse_Ctor(MAKE_RVA(0x000000140BAE830));
	...
	RelocAddr<uintptr_t>	kSubtitleManager_ShowSubtitle(MAKE_RVA(0x00000014107D990));
	...
	RelocAddr<uintptr_t>	kSubtitleManager_DisplayNextSubtitle(MAKE_RVA(0x00000014107E030));
